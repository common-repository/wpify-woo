...
class ViesEntity
{
    public function __construct(private string $vatNumber, private string $countryCode, private string $requesterMemberStateCode = '', private string $requesterNumber = '', private string $traderName = '', private string $traderStreet = '', private string $traderPostalCode = '', private string $traderCity = '', private string $traderCompanyType = '')
    {
    }
    /**
     * @return viesParam
